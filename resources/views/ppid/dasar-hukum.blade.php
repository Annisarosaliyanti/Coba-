...
@section('title', 'Dasar Hukum - PPID Kecamatan Sungai Pinang')
...
<section class="content-area">
    <div class="container">
        <div class="content-wrapper">
            <h2><i class="fas fa-gavel text-primary"></i> Dasar Hukum</h2>
            <p class="text-muted mb-4">Peraturan dan dokumen hukum terkait pelayanan informasi publik</p>
